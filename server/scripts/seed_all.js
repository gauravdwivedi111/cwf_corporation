  ...
  try {
    ...
    const webServices = [
      ...
      },
      {
        ...
        coverImage: '/web_cross_platform_portals.png',
        gallery: ['/web_cross_platform_portals.png'],
        icon: 'layers',
        isPublished: true,
        order: 2,
      ...
      },
      {
        ...
        coverImage: '/web_ecommerce_fulfillment.jpg',
        gallery: ['/web_ecommerce_fulfillment.jpg'],
        icon: 'shopping-bag',
        isPublished: true,
        order: 3,
      ...
      },
      {
        ...
        coverImage: '/web_mobile_cloud_apps.jpg',
        gallery: ['/web_mobile_cloud_apps.jpg'],
        icon: 'smartphone',
        isPublished: true,
        order: 4,
      ...
      },
      {
        ...
        coverImage: '/web_automation_command_center.png',
        gallery: ['/web_automation_command_center.png'],
        icon: 'cpu',
        isPublished: true,
        order: 7,
      ...
      },
      {
        ...
        coverImage: '/web_high_speed_infrastructure.jpg',
        gallery: ['/web_high_speed_infrastructure.jpg'],
        icon: 'cloud',
        isPublished: true,
        order: 8,
    ...
    const financeServices = [
      {
        ...
        coverImage: '/finance_investment_advisory.png',
        gallery: ['/finance_investment_advisory.png'],
        icon: 'briefcase',
        isPublished: true,
        order: 1,
        loanRangeMin: null,
      ...
      },
      {
        ...
        coverImage: '/finance_advisory_overview.png',
        gallery: ['/finance_advisory_overview.png'],
        icon: 'shield',
        isPublished: true,
        order: 2,
        loanRangeMin: null,
      ...
      },
      {
        ...
        coverImage: '/finance_loan_guidance.png',
        gallery: ['/finance_loan_guidance.png'],
        icon: 'file-text',
        isPublished: true,
        order: 3,
      ...
      },
      {
        ...
        coverImage: '/finance_cash_flow_planning.jpg',
        gallery: ['/finance_cash_flow_planning.jpg'],
        icon: 'calendar',
        isPublished: true,
        order: 7,
        loanRangeMin: null,
      ...
      },
      {
        ...
        coverImage: '/finance_startup_advisory.png',
        gallery: ['/finance_startup_advisory.png'],
        icon: 'activity',
        isPublished: true,
        order: 8,
        loanRangeMin: null,
